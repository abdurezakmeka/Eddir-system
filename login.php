...
<body>
    ...
    <main>
        <center>
            ...
            <input id="authbtn" type="submit" style="padding: 10px 51px;" value="Login">
            <a id="signup" href="signup.php">Signup</a><br>  <br>          
     ...
     <footer class="app-footer">
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <a href="./loginam.php"><i class="fa fa-language"></i></a>
                    አማርኛ
                </li>
