...
?>
  ...
  <main>
    ...
    <div class="Recipt" style="margin-top: 90px;">
                                    <Center>
                                            <strong></strong><br>
                                            <h2 style="text-align: center;">የክፍያ ማረጋገጫ<br>
                                            <span class="small" style="color:red;">በመረጋገጥ ላይ ነው...</span></h2><br><br>
                                            <span style="color: #6bbfcd;"> የማረጋገጫ ቁጥር: </span> 
                                            <?php 
                                                $today=date('sIsyI');
                                                echo $today;                                    
                                            ?><br>

                                            <span style="color: #6bbfcd;"> የከፈሉበት ቀን: </span> <?php echo $row["date"]; ?><br>
                                              
                                            <span style="color: #6bbfcd;">ስም: </span> <?php echo $row["name"]; ?><br>
                                            <span style="color: #6bbfcd;">Txn ID: </span> <?php echo $row["txnid"]; ?><br>
                                            <span style="color: #6bbfcd;">የክፍያው አይነት: </span> <?php echo $row["reason"]; ?><br>


                                    
                                    <div><button style="margin-top:15px" id="prbtn" onClick="window.print()">ገፁን ፕሪንት አድርግ </button><br></div>
